...
// console.log(`${favoriteThings.car} and ${favoriteThings.show} should have been added to the object.`)
...
// console.log(favoriteThings)
// console.log(`${favoriteThings.food} and ${favoriteThings.book} should have been changed to Chicken Nuggets and Harry Potter.`)
...
// console.log(greeting({title: 'Mr.', firstName: 'Barrett', lastName: 'Anderson'}));
...
// console.log(ingredients({carb: 'carb', fat: 'fat', protein: 'protein'}))
...
// console.log(`Your new name is ${user.name} and your new email is ${user.email}.`);
...
//Code Here
delete user.age;
// console.log(`Your age has been deleted from the object....`)
// console.log(user)
...
let cat1 = new Cat('Spuddy', 3, 'Green');
// console.log(`The name of your cat is ${cat1.name}.`);
...
let wizard1 = new Wizard('Harry', 12, 'Expelliarmus');
// console.log(wizard1);
...
//Code Here
let phone1 = new Phone('Apple', 'iPhone 12', 128, 'Blue', 1000);
let phone2 = new Phone('Samsung', 'Galaxy S21', 256, 'Black', 900);
let phone3 = new Phone('Google', 'Pixel 5', 64, 'White', 800);
...
const vehicle1 = new Vehicle(5, 'Blue', 1000);
// console.log(vehicle1.move(100));
...
//Code Here
const myFirstVehicle = new Vehicle(2, 'Silver', 500);
...
//Code Here 
const myFirstMotorcycle = new Motorcycle(1, 'Black', 1000, 'Harley Davidson', true);
...
//Code Here
const myFirstBoat = new Boat(10, 'White', 1000, 'The Boat of Boats', 'Cruise Ship', false);
